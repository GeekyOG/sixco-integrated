...
import { useLazyGetAllDocumentQuery } from "../api/documentApi";
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <Button
                  className="bg-red-600 hover:bg-red-700 text-white border-0 shadow-sm transition-colors duration-200"
                  ...
                  <div className="max-h-[500px] overflow-y-auto">
                    {data?.documents?.length > 0 ? (
                      ...
                      <div className="text-center py-12">
                        ...
                        <Button
                          className="mt-4 bg-red-600 hover:bg-red-700 text-white border-0 shadow-sm text-sm"
                  ...
                  {reportData?.report?.closedAt && (
                    <div className="flex items-center gap-3 p-4 bg-green-50 rounded-lg border border-green-200">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-900 font-semibold">
                          {formatDate(
                            new Date(reportData.report.closedAt),
                            "MMM d, yyyy HH:mm"
                          )}
                        </p>
                        {reportData?.report?.closer && (
                          <p className="text-xs text-gray-600 mt-1">
                            By {reportData.report.closer.firstName}{" "}
                            {reportData.report.closer.lastName}
                          </p>
                        )}
                      </div>
                    </div>
